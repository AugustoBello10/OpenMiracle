...
export const ATTRIBUTE_TYPES = [
  ...
  { id: 'death-prot', name: 'Death Protection', type: 'simple', valueType: 'protection' },
  { id: 'life-drain-prot', name: 'Life Drain Protection', type: 'simple', valueType: 'protection' },
  { id: 'elements-prot', name: 'Elements Protection', type: 'simple', valueType: 'protection' },
  { id: 'destruction', name: 'Destruction', type: 'simple', valueType: 'crit' },
