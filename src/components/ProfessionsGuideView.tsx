      ...
      case 'fishing':
        return (
          <div className="space-y-8 text-left text-stone-300 font-sans text-base leading-relaxed">
            ...
            <p className="mb-4 text-sm">{t('Existem varas raras, necessárias para pegar certos peixes ou pescar em outros tipos de terreno (como lava). Veja as receitas (craftadas na bigorna):', 'There are rare rods required to catch certain fishes or fish in other types of terrain (like lava). See the recipes (crafted on the anvil):')}</p>
    ...
    <div className="space-y-8 w-full">
      <header className="text-center mb-12">
        <h1 className="text-3xl sm:text-4xl font-black text-medieval-gold uppercase tracking-tighter mb-2 flex items-center justify-center gap-3">
           <Book className="w-8 h-8 text-medieval-gold" /> {t('Guias de Profissão', 'Profession Guides')}
        </h1>
