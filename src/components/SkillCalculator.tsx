    ...
    return (
      <div className="bg-black/30 border border-orange-500/20 rounded-xl p-5 relative overflow-hidden transition-all hover:bg-black/40 hover:border-orange-500/40">
        ...
        <div className="flex flex-col gap-5">
          ...
          <div className="flex flex-col lg:flex-row gap-6 items-center lg:items-stretch justify-between">
            
            {/* Weapons */}
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-6 lg:pr-4">
              {combo.Inferno > 0 && (
            ...
            <div className="flex-1 w-full grid grid-cols-1 sm:grid-cols-2 gap-4">
              {/* Cost */}
              <div className="bg-black/50 p-5 rounded-xl border border-medieval-gold/10 flex flex-col items-center justify-center text-center min-h-[100px]">
